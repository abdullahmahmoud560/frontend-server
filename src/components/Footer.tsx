        ...
        <div className={styles.footerTop}>
          ...
          <div className={styles.footerColumn}>
            ...
            <ul className={styles.footerLinks}>
              ...
              <li><Link href="/about">عن الغرفة</Link></li>
              <li><Link href="/services">الخدمات</Link></li>
              <li><Link href="/committees">اللجان</Link></li>
          ...
          <div className={styles.footerColumn}>
            ...
            <ul className={styles.footerLinks}>
              <li><Link href="/services/membership">خدمات العضوية</Link></li>
              <li><Link href="/services/training">التدريب</Link></li>
              <li><Link href="/services/business">خدمات رجال الأعمال</Link></li>
              <li><Link href="/services/investment">الفرص الاستثمارية</Link></li>
              <li><Link href="/services/certification">التصديق الإلكتروني</Link></li>
          ...
          <div className={styles.footerColumn}>
            ...
            <ul className={styles.contactInfo}>
              <li>
                ...
                <span>بيشة، المملكة العربية السعودية</span>
              </li>
            </ul>
          </div>
        </div>
